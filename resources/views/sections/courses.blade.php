  ...
  <div class="container-fluid px-0 py-5">
    ...
    <div class="owl-carousel courses-carousel">
        ...
        <div class="courses-item position-relative">
            <img class="img-fluid" src="/images/courses/{{  $course->image }}" alt="">
            <div class="courses-text">
                <h4 class="text-center text-white px-3">{{ $course->title }}</h4>
                <div class="border-top w-100 mt-3">
                    <div class="d-flex justify-content-between p-4">
                        <span class="text-white"><i class="fa fa-user mr-2"></i>{{ $course->span1 }}</span>
                        <span class="text-white"><i class="fa fa-star mr-2"></i>{{ $course->span2 }}</span>
                    </div>
                </div>
                <div class="w-100 bg-white text-center p-4" >
                    <a class="btn btn-primary" href="{{ $course->url }}">Course Detail</a>
                </div>
            </div>
        </div>
        @endforeach
