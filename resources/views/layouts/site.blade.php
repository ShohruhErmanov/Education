        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center text-white">
                    @foreach ($topbars as $topbar)
                        <small><i class="{{ $topbar->topbaricon }}"></i><a href="{{ $topbar->link }}"
                                style="color: white; text-decoration: none">{{ $topbar->topbar }}</a></small>
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    @foreach ($topbaricons as $topbaricon)
                        <a class="text-white px-2" href="{{ $topbaricon->link }}" target="_blank">
                            <i class="{{ $topbaricon->topbaricon }}"></i>
                        </a>
                    @endforeach
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="{{ route('dashboard') }}" target="_blank" class="btn btn-primary py-2 px-4 d-none d-lg-block">Login</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    @foreach ($contacts as $contact)
                        <p><i class="{{ $contact->icon }} mr-2 fa-1x"></i>{{ $contact->text }}</p>
                    @endforeach

                    <div class="d-flex justify-content-start mt-4">
                        @foreach ($topbaricons as $topbaricon)
                        <a class="text-white mr-4 fa-2x" href="{{ $topbaricon->link }}"><i class="{{ $topbaricon->topbaricon }}"></i></a>
                        @endforeach
